-- CreateEnum
CREATE TYPE "Tag" AS ENUM ('WORK', 'PERSONAL', 'FAMILY', 'HEALTH', 'SOCIAL', 'EDUCATION', 'OTHER', 'MEETING');

-- CreateEnum
CREATE TYPE "EventStatus" AS ENUM ('SCHEDULED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "MeetingType" AS ENUM ('IN_PERSON', 'VIRTUAL', 'HYBRID');

-- CreateEnum
CREATE TYPE "AttendeeStatus" AS ENUM ('INVITED', 'CONFIRMED', 'DECLINED', 'TENTATIVE');
